...
export function EegRecommendations({ recommendations }: { recommendations: string[] }) {
  return (
    <Card>
      <CardContent className="p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-slate-500">
          These next steps are selected from the emphasized EEG pattern and the recording quality.
        </p>
