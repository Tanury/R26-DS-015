...
export default function GeneralAssessmentPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (validCount !== featureKeys.length) { setError("Enter a finite numeric value for every measurement."); return; }
